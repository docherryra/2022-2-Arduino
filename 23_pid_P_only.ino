...
// Servo adjustment        
//#define _DUTY_NEU 1380  // Servo angle: 0 degree
//#define _DUTY_MAX 2380  // Servo angle: D degree
//#define _DUTY_MIN 380  // Servo angle: E degree
#define _DUTY_NEU 1500  // Servo angle: 0 degree
#define _DUTY_MAX 2900  // Servo angle: D degree
#define _DUTY_MIN 100  // Servo angle: E degree


#define _SERVO_ANGLE_DIFF 260 // Replace with |D - E| degree
#define _SERVO_SPEED 1000 // servo speed limit (unit: degree/second)

// PID parameters
#define _KP 5 // proportional gain
...
void setup()
{
  ...
  dist_target = 190; // the center of the rail (unit: mm)
